...
public class DdLinearLayout extends ViewGroup{

    public DdLinearLayout(Context context) {
        super(context);
    }

    public DdLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DdLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
