...
public class FrameLayout extends ViewGroup {
    ...
    public FrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mForegroundGravity = a.getInt(
                R.styleable.FrameLayout_dd_foregroundGravity, mForegroundGravity);

        final Drawable d = a.getDrawable(R.styleable.FrameLayout_dd_foreground);
        if (d != null) {
            setForeground(d);
        }
        
        if (a.getBoolean(R.styleable.FrameLayout_dd_measureAllChildren, false)) {
            setMeasureAllChildren(true);
        }

        mForegroundInPadding = a.getBoolean(
                R.styleable.FrameLayout_dd_foregroundInsidePadding, true);
...
//    }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            gravity = a.getInt(R.styleable.FrameLayout_Layout_dd_layout_gravity, -1);
            a.recycle();
        }
