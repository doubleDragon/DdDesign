...
public class AppBarLayout extends LinearLayout{
     ...
     * an {@link AppBarLayout.OnOffsetChangedListener} when the offset has changed in such a way to require an
     * elevation change.
     *
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, AppBarLayout abl) {
            ...
            if (offsetChild != null) {
                ...
                if ((lp.getScrollFlags() & AppBarLayout.LayoutParams.FLAG_SNAP) == AppBarLayout.LayoutParams.FLAG_SNAP) {
        ...
        private void dispatchOffsetUpdates(AppBarLayout layout) {
            ...
            for (int i = 0, z = listeners.size(); i < z; i++) {
                final AppBarLayout.OnOffsetChangedListener listener = listeners.get(i);
                if (listener != null) {
